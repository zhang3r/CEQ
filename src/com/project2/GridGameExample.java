...
public class GridGameExample {
	...
	public static void VICoCoTest() {
		...
		JointRewardFunction rf = new GridGame.GGJointRewardFunction(domain, -1,
				100, false);
		...
		MAValueIteration vi = new MAValueIteration(domain, rf, tf, 0.99,
				hashingFactory, 0., new CoCoQ(), 0.00015, 50);
		...
		MultiAgentDPPlanningAgent a0 = new MultiAgentDPPlanningAgent(domain,
				vi, new PolicyFromJointPolicy(0, jp0), "agent0", at);
		MultiAgentDPPlanningAgent a1 = new MultiAgentDPPlanningAgent(domain,
				vi, new PolicyFromJointPolicy(1, jp0), "agent1", at);
	...
	public static void VICorrelatedTest() {
		...
		SGAgentType at = GridGame.getStandardGridGameAgentType(domain);
		MAValueIteration vi = new MAValueIteration(
				domain,
				rf,
				tf,
				0.99,
		...
		MultiAgentDPPlanningAgent a0 = new MultiAgentDPPlanningAgent(domain,
				vi, new PolicyFromJointPolicy(0, jp0, true), "agent0", at);
		MultiAgentDPPlanningAgent a1 = new MultiAgentDPPlanningAgent(domain,
				vi, new PolicyFromJointPolicy(1, jp0, true), "agent1", at);
	...
	public static void saInterface() {
		...
		GenericOOState s = new GenericOOState(
				new SoccerAgent(false, 1, 1, 0, "agent0"),
				new SoccerAgent(true, 2, 1, 1, "agent1"),
				new GGGoal(0, 0, 1, "g0"),
				new GGGoal(2, 2, 2, "g1")
				
		);

		SoccerGame.setBoundaryWalls(s, 3, 3);
						
		JointRewardFunction rf = new SoccerGame.GGJointRewardFunction(domain, -1,
				100, false);
		TerminalFunction tf = new SoccerGame.GGTerminalFunction(domain);
		SGAgentType at = SoccerGame.getStandardSoccerGameAgentType(domain);
		...
		// will provide it
		QLearning ql1 = new QLearning(null, 0.99,
				new SimpleHashableStateFactory(), 0, 0.1);
		QLearning ql2 = new QLearning(null, 0.99,
				new SimpleHashableStateFactory(), 0, 0.1);
